...
# This time, I keep the age down and the mileage way up, the output should be around 1500.

# This is also not a bad prediction.
# But now let's see what happens when we crank up the age and keep the mileage loe.