...
# OK. Since the learning rate was so low,the amount of epochs needed to be high.
# The cost went down, and I'm curious how well we are doing.
# Let me print the weights and bias after the training and execute the code once again.