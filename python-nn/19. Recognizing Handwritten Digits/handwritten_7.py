...
# All we do now is loop through the test samples and keep a score of correctly guessed images.
...
# I let the program run and print the result. I let the training run a few times, and because of the random weight initialization, I get different results each time.
# The overall result is pretty impressive if you realize that an untrained network would be able to predict an average of only 10 percent of the digits correctly.
# And I'm curious. What do the images look like that were not predicted correctly?
# I'll print the samples that are not guessed correctly.