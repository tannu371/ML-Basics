...
# We normalized the inputs, and the relationship between input and output is now difficult to see.
# Take the weights and bias and use them to plot a regression plane again.
# This time you see that both the age as well as mileage, influence the maintenance costs.