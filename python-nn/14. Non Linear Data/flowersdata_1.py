# Let's use the new non-linear training inputs.
# Change the label names of the one hot encoding.
# training targets
# test inputs
# test targets

# Excecute the code and see how well the network deals with this non-linear data.
