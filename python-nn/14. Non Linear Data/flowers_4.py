...
# Nope. It seems the network is stuck at around 73 percent.
# Although the cost is still decresing a bit, this kind of brute force won't bring us to the goal anytime soon.
# We need a new strategy. Network with two layers has some trouble dealing with nonlinear data.
# The solution to this problem is to add a layer to the system.
