...
# Now use the test data to test the network.
# calculate the predictions of the hidden layer. activate the predictions with the ReLU activation function. 
# calculate the predictions of the output layer. activate the predictions with the softmax activation function.
# go through the activations and compare them to the targets.

# In an untrained network, the score is 33 percent.
