...
# 96 percent that is impressive. We can optimize the parameters further to get a score of 100 percent.
# But it is more interesting to find which test sample was not predicted correctly.